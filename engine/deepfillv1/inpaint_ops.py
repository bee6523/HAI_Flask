...
def contextual_attention(f, b, mask=None, in_att=None, ksize=3, stride=1, rate=1,
    ...
    """
    print(f'Called: contextual_attention()')
    
    print(f'Shape of foreground features: {f.shape}')
    ...
    if mask is not None:
        print(f'Shape of resized masks: {mask.shape}')
    ...
    print(f'Shape of downscaled background patches (w): {w.shape}')
    ...
    print(f'Shape of mask patches: {mm.shape}')
